...
const projects = [
  {
    ...
    description:
      "EllasTouch Makeover is a booking website and portfolio for a professional makeup artist. It allows clients to view the artist's work and easily book makeup services for events like parties, weddings, and photo shoots",
    technologies: [
      "React",
      "Typescript",
      "Tailwind CSS",
...
const ProjectPage = () => {
  ...
  return (
    <div className="container h-screen mb-60 mx-auto p-6 text-sm text-[--primary-color] flex flex-col items-center">
          ...
          <header className="text-left mb-6">
            ...
            <div className="mt-6">
              ...
              <a
                target="_blank"
                href={project.link}
                className="text-xs mt-3 text-[--main-color]"
              >
                Visit the website
              </a>
            </div>
            ...
            <div className="relative flex justify-center">
              {project.images.map((image, idx) => (
                <TinderCard
                  key={idx}
                  onSwipe={onSwipe}
                  className={`absolute  bg-white shadow-lg rounded-xl overflow-hidden ${
                    idx === currentIndex ? "z-10" : "z-0"
                  }`}
                  preventSwipe={["up", "down"]}
                  style={{
                    transform:
                      idx === currentIndex ? "rotate(3deg)" : "rotate(0deg)",
                ...
                >
                  <div className="w-full h-full relative">
                    ...
                    />
                    <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 z-20 pointer-events-none text-center">
